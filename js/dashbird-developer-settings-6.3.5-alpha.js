...
Dashbird.Views = {};
Dashbird.Views.Settings = {};
Dashbird.Views.Settings.Settings = SimpleJSLib.BaseObject.inherit(function(me, _protected){
    _protected.persons = {};
    _protected.password = {};
    ...
    _protected.persons.addPersonClick = function(e){
        ...
        Dashbird.Controllers.UserSettings.addUserShare(name, function(){
    ...
    _protected.password.changePasswordClick = function(e){
         ...
         Dashbird.Controllers.UserSettings.changePassword(oldPassword, newPassword, function(ajaxResponse){
             var $alert = null;
             if(ajaxResponse.isSuccess){
...
$(document).ready(function (){
    ...
    Dashbird.Views.Settings.Settings.init();
});
