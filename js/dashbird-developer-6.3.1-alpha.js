...
Dashbird.Controllers.Utils = {};
Dashbird.Controllers.Utils.AJAX = {
   'STATUS': 'STATUS',
...
Dashbird.ViewModels.PostFeed =  SimpleJSLib.EventHandler.inherit(function(me, _protected){
    _protected.drawingManager = null;
    _protected.activityFeedLayer = null;
    _protected.construct = function(parameters){
        ...
        _protected.activityFeedLayer = Dashbird.ViewModels.ActivityFeed.construct(me ,_protected.$activity.find('ul'));
        _protected.drawingManager = Dashbird.ViewModels.Utils.DrawingManager.construct(me.redraw, me.isAllowedToRedraw, ['viewed']);
...
Dashbird.Commands.Share = Dashbird.Commands.Base.inherit(function(me, _protected){
    ...
    _protected.draw = function(){
        ...
        $.each(Dashbird.Controllers.User.getUserShares(), function(key, element){
...
Dashbird.ViewModels.Utils = {};
Dashbird.ViewModels.Utils.DrawingManager =  SimpleJSLib.BaseObject.inherit(function(me, _protected){
...
Dashbird.Views.Board.NewPost = SimpleJSLib.EventHandler.inherit(function(me, _protected){
    _protected = {};
    _protected.tags = [];
    _protected.bbcode= {};
...
Dashbird.Views.Utils = {};
Dashbird.Views.Utils.Modal = function(){
    var me = {},
    _private = {};
...
$(document).ready(function (){
    ...
    Dashbird.Views.Board.Notification.init();
    Dashbird.Views.Utils.Templates.init();
    Dashbird.Controllers.User.init();
    Dashbird.Views.Board.Feed.init();
    Dashbird.Views.Board.Latest.init();
    Dashbird.Views.Board.Stack.init();
    Dashbird.Views.Board.NewPost.init();
    Dashbird.Views.Utils.Modal.init();
    Dashbird.Views.Board.Search.init();
    Dashbird.Controllers.Posts.init();
    Dashbird.Views.Board.SingleView.init();
